...
const Notification = () => {
  ...
  return (
    <div className='nav-item absolute right-5 md:right-20 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96'>
      ...
      <div className='mt-5 '>
        ...
        <div className='mt-5'>
          <ButtonIcon color='white' bgColor={currentColor} text='See all notifications' borderRadius='10px' width='full' />
        </div>
      </div>
    </div>
  );
